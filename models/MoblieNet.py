...
class DepthwiseConv2d(Module):
    ...
    def __init__(self, in_channel, kernel_size, stride=1, padding=0,
        ...
        self.depthwise = [nn.Conv2d(in_channels=1, out_channels=1, kernel_size=kernel_size, stride=stride,
...
if __name__ == '__main__':
    ...
    test_in = torch.randn(size=(1,3,224,224)).to(device)

    net = MobileNet(10).to(device)
